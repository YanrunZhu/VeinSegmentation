...
from torch.cuda.amp import GradScaler #from torch import GradScaler
...
class nnUNetTrainer(object):
    def __init__(self, plans: dict, configuration: str, fold: int, dataset_json: dict,
        ...
        self.grad_scaler = GradScaler() if self.device.type == 'cuda' else None #self.grad_scaler = GradScaler("cuda") if self.device.type == 'cuda' else None
